...
set DISCORD_STRATEGY=--dpi-desync=fake --dpi-desync-repeats=10 --dpi-desync-fake-discord=0x00 --dpi-desync-fake-stun=0x00
set QUIC_STRATEGY=--dpi-desync=fake --dpi-desync-repeats=10 --dpi-desync-fake-quic="%FAKE_QUIC%"
set UDP_STRATEGY=--dpi-desync=fake --dpi-desync-ttl=8 --dpi-desync-repeats=16 --dpi-desync-any-protocol=1 --dpi-desync-fooling=none --dpi-desync-fake-unknown-udp="%FAKE_UDP%" --dpi-desync-cutoff=n8
...
set HTTPS_STRATEGY=--dpi-desync=split --dpi-desync-split-pos=1 --dpi-desync-autottl --dpi-desync-fooling=badseq --dpi-desync-repeats=8 --dpi-desync-fake-tls="%FAKE_TLS%"
