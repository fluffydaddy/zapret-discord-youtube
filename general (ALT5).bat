...
--comment Amazon --filter-udp=1024-65535 --ipset="%LISTS%ipset-amazonaws.txt" --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=14 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_www_google_com.bin" --dpi-desync-cutoff=n3  --new ^
...
--comment Warframe --filter-udp=3074-3480,4950-4955,4960-4965,4970-4975,4980-4985,4990-4995 --ipset="%LISTS%ipset-warframe.txt" --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=14 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_www_google_com.bin" --dpi-desync-cutoff=n3 --new ^
--comment Warframe --filter-tcp=6695-6705 --ipset="%LISTS%ipset-warframe.txt" --dpi-desync=syndata --new ^

--comment Linode --filter-tcp=80,1024-65535 --ipset="%LISTS%ipset-linodeusercontent.txt" --ipset="%LISTS%ipset-panicartstudios.txt" --dpi-desync=fake,split2 --dpi-desync-autottl=2 --dpi-desync-fooling=md5sig --new ^
--comment Linode --filter-udp=443,1024-65535 --ipset="%LISTS%ipset-linodeusercontent.txt" --ipset="%LISTS%ipset-panicartstudios.txt" --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin"
