...
set DISCORD_STRATEGY=--dpi-desync=fake --dpi-desync-repeats=14 --dpi-desync-fake-discord=0x00 --dpi-desync-fake-stun=0x00
set QUIC_STRATEGY=--dpi-desync=fake --dpi-desync-repeats=14 --dpi-desync-fake-quic="%FAKE_QUIC%"
set UDP_STRATEGY=--dpi-desync=fake --dpi-desync-ttl=6 --dpi-desync-repeats=14 --dpi-desync-any-protocol=1 --dpi-desync-fooling=none --dpi-desync-fake-unknown-udp="%FAKE_UDP%" --dpi-desync-cutoff=n6
