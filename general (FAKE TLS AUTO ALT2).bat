...
set DISCORD_STRATEGY=--dpi-desync=fake --dpi-desync-repeats=11 --dpi-desync-fake-discord=0x00 --dpi-desync-fake-stun=0x00
...
set HTTPS_STRATEGY=--dpi-desync=fake,multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-repeats=8 --dpi-desync-autottl --dpi-desync-fooling=badseq --dpi-desync-split-seqovl-pattern="%FAKE_TLS%" --dpi-desync-fake-tls-mod=rnd,dupsid,sni=www.google.com
