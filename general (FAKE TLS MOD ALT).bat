...
set DISCORD_STRATEGY=--dpi-desync=fake --dpi-desync-ttl=4 --dpi-desync-repeats=10
...
set HTTPS_STRATEGY=--dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=rnd,rndsni,padencap
