...
set DISCORD_STRATEGY=--dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=8
set QUIC_STRATEGY=--dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=8 --dpi-desync-fake-quic="%FAKE_QUIC%"
