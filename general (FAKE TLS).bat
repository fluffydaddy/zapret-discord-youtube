...
set HTTP_STRATEGY=--dpi-desync=fake,multisplit --dpi-desync-autottl=3 --dpi-desync-fooling=md5sig --dpi-desync-fake-http="%FAKE_HTTP%"
set HTTPS_STRATEGY=--dpi-desync=fake --dpi-desync-ttl=4 --dpi-desync-fake-tls-mod=rnd,rndsni,padencap
