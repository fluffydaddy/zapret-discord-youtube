...
::--comment Amazon ... --dpi-desync-fake-unknown-udp=0x2954afd72932231e
...
::--comment WireGuard --filter-udp=0-65535 --filter-l7=wireguard --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=md5sig --dpi-desync-fake-wireguard="%BIN%quic_initial_www_google_com.bin" --new ^
...
--comment Linode --filter-tcp=80,443,6600-6700,9000-9090 --ipset="%LISTS%ipset-linodeusercontent.txt" --dpi-desync=fake,split2 --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin" --new ^
