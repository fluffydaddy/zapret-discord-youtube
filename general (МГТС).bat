...
set DISCORD_STRATEGY=--dpi-desync=fake --dpi-desync-ttl=4 --dpi-desync-repeats=6
set QUIC_STRATEGY=--dpi-desync=fake --dpi-desync-ttl=4 --dpi-desync-repeats=6 --dpi-desync-fake-quic="%FAKE_QUIC%"
...
set HTTPS_STRATEGY=--dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%FAKE_TLS%"
